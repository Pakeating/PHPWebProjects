...
<html lang="es">
  ...
  <body>
    ...
    <div class="container" style="margin-top: none">
        <a class="navbar-brand  text-white" href="#">¡Compra tu disfraz!</a>
    ...
    <div class="container">    
        <div class="row mt-5">
            ...
            <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div class="card" >
                    <img height="213px" class="card-img-top" src="images/<?php echo $producto->imagen;?>">
                    <div class="card-body" >
                        ...
                        <p><?php echo $producto->descripcion;?> </p>
                         <a href="#"  class="btn btn-primary w-100 rounded my-2"> Comprar <i class="fas fa-arrow-right"></i> </a>      
